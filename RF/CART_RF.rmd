...
```{r}
model = randomForest(formula = Class ~ V1 + V2 + V3 + V4 + V5 + V6 + V7 + V8 + V9 + V10 + V11 + V12 + V13 + V14 + V15 + V16 + V17 + V18 + V19 + V20 + V21 + V22 + V23 + V24 + V25 + V26 + V27 + V28 + V29 + V30 + V31 + V32 + V33 + V34, data = Ionosphere.train, ntree=130, mtry=16)
print(rf)
```
...
```{r}
model_with_norm = randomForest(formula = Class ~ N1 + N2 + N3 + N4 + N5 + N6 + N7 + N8 + N9 + N10 + N11 + N12 + N13 + N14 + N15 + N16, data = Ionosphere.with_norms.train)
...
library(ggcorrplot)
ggcorrplot(Ionosphere.with_norms[3:6])
```
