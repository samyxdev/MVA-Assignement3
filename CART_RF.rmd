...
```{r}
rf = randomForest(formula = Class ~ V1 + V2 + V3 + V4 + V5 + V6 + V7 + V8 + V9 + V10 + V11 + V12 + V13 + V14 + V15 + V16 + V17 + V18 + V19 + V20 + V21 + V22 + V23 + V24 + V25 + V26 + V27 + V28 + V29 + V30 + V31 + V32 + V33 + V34, data = Ionosphere.train, ntree=1000, mtry=10)
print(rf)
```

We changed the default number of tree parameters to 1000 instead of 500.
```{r}
plot(rf, main="Random forest")
png(file="rf.png")
```

We can see that our error rates are reaching a stationary state after ~800 trees.
